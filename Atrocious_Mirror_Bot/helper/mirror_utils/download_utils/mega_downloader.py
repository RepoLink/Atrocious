from Atrocious_Mirror_Bot import LOGGER, MEGA_API_KEY, download_dict_lock, download_dict, MEGA_EMAIL_ID, MEGA_PASSWORD
import threading
from mega import (MegaApi, MegaListener, MegaRequest, MegaTransfer, MegaError)
from Atrocious_Mirror_Bot.helper.telegram_helper.message_utils import *
import os
from Atrocious_Mirror_Bot.helper.ext_utils.bot_utils import new_thread, get_mega_link_type, get_readable_file_size, check_limit
from Atrocious_Mirror_Bot.helper.mirror_utils.status_utils.mega_download_status import MegaDownloadStatus
from Atrocious_Mirror_Bot.helper.mirror_utils.upload_utils.gdriveTools import GoogleDriveHelper
from Atrocious_Mirror_Bot import MEGA_LIMIT, STOP_DUPLICATE, TAR_UNZIP_LIMIT
import random
import string
